...
\par In next, we describe the details of adapting this protocol with the pattern prediction (\pmcmr) models.


Our proposed method is based on distributed online prediction protocol adapting .This protocol provides a communication-efficient dynamic synchronization scheme based on a periodic static scheme. 
