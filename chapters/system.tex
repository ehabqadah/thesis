...
\begin{center}
	...
	\draw [black] (11.2,-26.3) circle (3);
	\draw (11.2,-26.3) node {$0$};
	\draw [black] (27.6,-26.3) circle (3);
	\draw (27.6,-26.3) node {$2$};
	\draw [black] (43,-26.3) circle (3);
	\draw (43,-26.3) node {$3$};
	\draw [black] (9.47,-23.86) arc (207.65998:-27.65998:11.211);
	\fill [black] (29.33,-23.86) -- (30.14,-23.38) -- (29.26,-22.92);
	\draw (19.4,-6.94) node [above] {$0$};
	\end{tikzpicture}
\end{center}
