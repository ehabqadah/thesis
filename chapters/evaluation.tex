...
\par We also conducted experiments to measure the throughput of our system on a Hadoop YARN \footnote{\url{https://hadoop.apache.org/docs/current/hadoop-yarn/hadoop-yarn-site/YARN.html}} cluster (v2.7.2) with 9 physical nodes, where each node has 10 cores CPU, and 100 GB memory.
