...
\par In this chapter, we survey some of the related research in the areas of pattern prediction over event streams task, and techniques of distributed online learning over data streams. Then we give a brief overview of the Big Data platforms that we used to implement our proposed system.  
\section{Related Work}
\input{chapters/pattern_prediction}
\input{chapters/distributedOnlineLearning}
\input{chapters/technological_background}
